<template>
  <header
    class="flex h-auto items-center justify-between shadow border-b border-gray-200 dark:border-gray-700"
  >
    <div class="px-2 py-1">
    ...
    <div class="px-2 py-1">
      <span class="relative z-0 rounded-full">
        <svg
          v-if="!isDark"
          xmlns="http://www.w3.org/2000/svg"
          class="w-4 h-4 outline-none cursor-pointer"
          viewBox="0 0 24 24"
          @click="toggleDark()"
        >
          <path
